...
class Pharmacy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Map<String, dynamic> pharmacy = pharm(context);
    return Scaffold(
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              itemCount: pharmacy['Unilag'].length,
              itemBuilder: (context, value) {
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(
                        pharmacy['Unilag'][value]['image'],
                      ),
                      const SizedBox(
                        height: 10,
                      ),
                      Text(
                        pharmacy['Unilag'][value]['name'],
                        ...
                        child: TextButton(
                          ...
                          onPressed: () async {
                            ...
                            var currentDestination = await LocationService()
                                .getPlace(clinicname['Unilag'][value]['name']);
